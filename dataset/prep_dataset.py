...
WIDTH, HEIGHT = 1*640 // FLAGS.downsample, 1*480 // FLAGS.downsample
NUM_CLASSES = 10
...
if FLAGS.subset:
    dest = 'data_a{}_subset.pkl'.format(FLAGS.downsample)
else:
    dest = 'data_a{}.pkl'.format(FLAGS.downsample)

with open(dest, 'wb') as f:
    #pickle.dump((X_train, y_train, X_test, X_test_ids, driver_ids), f)
    pickle.dump((X_train, y_train, driver_ids), f)
